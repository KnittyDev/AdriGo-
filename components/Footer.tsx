    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-4 border-t border-gray-200 py-6 md:flex-row">
          <p className="text-sm text-text-secondary">© 2024 AdriGo+. All rights reserved.</p>
          <div className="flex items-center gap-6">
            ...
            <a className="text-sm text-text-secondary transition-colors hover:text-text-primary" href="/contact">Contact Us</a>
          </div>
        </div>
      </div>
    </footer>
